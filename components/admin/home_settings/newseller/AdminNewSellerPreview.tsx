...
interface AdminNewSellerPreviewProps {
  _pageId?: string;
  page: {
    path: string;
    section: string;
...
export default function AdminNewSellerPreview({
  _pageId,
  page = {
    path: "home",
    section: "new-seller",
  ...
  return (
    <div className="">
      <Card className="w-full mb-8">
        <CardHeader>
          <CardTitle>New Seller Section Preview</CardTitle>
        </CardHeader>
        <CardContent>
