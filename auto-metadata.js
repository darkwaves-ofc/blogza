...
const prompt = `Give me the whole code. Please analyze the code and create appropriate metadata for this page by following these steps:

1. First, analyze the current page's purpose, functionality, and content
2. Based on the analysis, generate appropriate metadata including:
   - A descriptive title that follows the template pattern
   - A relevant description of the page's purpose
   - Keywords that match the page's content and context

Use this metadata template structure:
...
export const metadata: Metadata = {
  title: {
    ...
    default: "LMS - Mahinda Rajapaksa College Matara",
    absolute: "LMS - Mahinda Rajapaksa College",
  },
  description: "REPLACE_WITH_PAGE_SPECIFIC_DESCRIPTION",
  keywords: [
    ...
    "REPLACE_WITH_PAGE_SPECIFIC_KEYWORDS"
  ],
};

Please ensure the description and keywords are specifically tailored to the page's content while maintaining consistency with the school's branding.`;
