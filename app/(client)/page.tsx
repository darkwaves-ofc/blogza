            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 md:pl-12">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  DarkWaves is your portal to the enigmatic and awe-inspiring
                  wonders of the cosmos. Our passionate team of writers and
                  researchers are dedicated to unraveling the mysteries of the
                  universe, from the depths of black holes to the farthest
                  reaches of space.
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Join us on this cosmic journey as we explore cutting-edge
                  scientific discoveries, delve into theoretical physics, and
                  ponder the philosophical implications of our vast and
                  mysterious universe.
                </p>
                <Link href="/about">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <form className="max-w-md mx-auto">
              <div className="flex">
                ...
                <Button
                  type="submit"
                  className="rounded-l-none bg-purple-800 hover:bg-purple-900"
                >
                  Subscribe
                </Button>
              </div>
